...
"}")
        ...
        self.label_description.setGeometry(QtCore.QRect(0, 170, 661, 71))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(_translate("SplashScreen", "<html><head/><body><p>Text Editor</p></body></html>"))
        self.label_description.setText(_translate("SplashScreen", "<html><head/><body><p>Final AP Project</p><p align=\"center\">Summer-2022</p></body></html>"))
        self.label_loading.setText(_translate("SplashScreen", "loading..."))
        self.label_credits.setText(_translate("SplashScreen", "<html><head/><body><p><span style=\" font-weight:600;\">Created</span>: By MAH Group</p></body></html>"))
